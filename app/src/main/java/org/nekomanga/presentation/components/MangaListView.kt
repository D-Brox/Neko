...
fun MangaRow(
    ...
    Box(modifier = modifier) {
        Row(
            ...
            MangaListCover(displayManga = displayManga, dynamicCover = dynamicCover)
...
@Composable
private fun RowScope.MangaListCover(displayManga: DisplayManga, dynamicCover: Boolean) {
